...
function PackageCard({}: Props) {
  return (
    ...
    w-[400px] md:w-[600px] xl:w-[800px] snap-center bg-green-900 p-10 
    hover:opacity-100 opacity-70 cursor-pointer transition-opacity duration-200 overflow-hidden"
    >
      <div className="px-0 md:px-10">
        <h4 className="text-4xl font-light">CREMATION ONLY PACKAGE</h4>
        <p className="font-bold text-2xl mt-5">$2,425 + GST</p>
        <p className="my-3">
