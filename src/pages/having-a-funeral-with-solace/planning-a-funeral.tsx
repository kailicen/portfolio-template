        ...
        <div className="px-4 md:px-10 py-8 md:py-12">
          ...
          >
            ...
            <p className="mt-6 text-lg text-gray-700 leading-relaxed">
              At Solace, we can help with any kind of planning you would like to
              do. If you need a funeral plan, we can help. Stuck for how to put
              together an Advance Care Plan? We can help with that as well. It
              can be hard to get your head around all the end of life documents
            ...
            <div className="bg-emerald-50/60 border border-emerald-100 rounded-2xl p-6 md:p-8">
              ...
              <div className="mt-6 space-y-5 text-lg text-gray-700 leading-relaxed">
                ...
                <p>
                  ...
                  Advocacy Network have some really useful fact sheets and tips
                  on the various types of planning you could do.
                </p>

                <p>
                  A good place to start is by completing a Wishes Booklet which
                  will document all the wishes around the kind of funeral you
                  might like, the ways you want to be treated but also record
                  all the things your executor might need to know to address
                  your estate.
                </p>
          ...
          <section className="mb-12">
            ...
            <div className="mt-6 space-y-5 text-lg text-gray-700 leading-relaxed max-w-4xl">
              <p>
                ...
                transport, celebrancy and interment, NDAN endeavours to outline
                the options for traditional and contemporary funeral choices.
              </p>
            ...
            <div className="bg-emerald-700 text-white rounded-2xl p-6 md:p-8">
              ...
              <div className="space-y-4 text-emerald-50 leading-relaxed">
                ...
                <p>
                  ...
                  Australian culture to weave our grief and bereavement around.
                  By pricing people out of a ceremony they are removed from all
                  the things that a good ceremony can provide; a network of
                  shared grief, peer support and the act of service, namely,
                  showing up and honoring your person.
                </p>

                <p>
                  However, in many cases, you will never need a funeral director
                  for any of this. Often, people choose to have a cremation only
                  when someone dies and then plan a memorial gathering
                  themselves at a convenient time.
                </p>

                <p>
                  This can be a good way to keep the costs down and still gather
                  community to offer support, grieve and mourn together.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-12 bg-emerald-50/60 border border-emerald-100 rounded-2xl p-6 md:p-8">
            ...
            <div className="mt-6 space-y-5 text-lg text-gray-700 leading-relaxed">
              <p>
                Knowing what choices are available to you and having the time to
                consider what feels right, gives you the opportunity to go into
                that planning from an informed position and it enables you to
                deal with professionals on your own terms.
              </p>

              <p>
                You may still want to use a funeral director but you get to pick
                and choose the tasks you want them to undertake.
              </p>

              <p>
                NDAN&apos;s funeral planning factsheet is designed to give you
                an idea of what options may be available to you and, given that
                knowledge, inform the discussions you have with your family,
                friends, and end of life and death care providers.
              </p>
          ...
          <section className="mb-12 bg-gray-50 border border-gray-200 rounded-2xl p-6 md:p-8">
            ...
            <div className="mt-6 space-y-5 text-lg text-gray-700 leading-relaxed">
              <p>
                ...
                your State or Territory. Information specific to Tasmania can be
                found here.
              </p>
              ...
              <p>
                ...
                both personal and medical, and set the framework for the people
                who will care for and interact with you. Section 2 can be a good
                one to talk to your medical people about. This section records
                all the interventions, medications and treatments you may want
                to refuse, and the circumstances under which you would refuse
                them.
              </p>

              <p>
                The Natural Death Advocacy Network has some more information as
          ...
          <section className="bg-emerald-700 text-white rounded-2xl p-6 md:p-8 mb-8">
            ...
            <p className="mt-4 text-emerald-50 leading-relaxed max-w-3xl">
              If you want to do it yourself, we are always happy to pass on our
              contacts for the people we use when planning funerals. So if
