    ...
    <>
      ...
      <main className="max-w-6xl mx-auto w-full 2xl:max-w-7xl flex-1">
        ...
        <motion.div
          ...
          className="px-4 md:px-10 py-8 md:py-12"
        >
          ...
          <section className="grid lg:grid-cols-[1.2fr_0.8fr] gap-10 mb-12">
            <div className="space-y-5 text-gray-700 leading-relaxed">
              <p>
                Our years of experience in and around dying and death mean that
                we are well placed to help with an information flow which can
                otherwise be all too hard to find!
              </p>
              <p>
              ...
              <blockquote className="border-l-4 border-emerald-600 pl-6 py-4 bg-gray-50 rounded-r-lg">
                <p className="italic text-gray-800">
                  ...
                  something we are very passionate about. Much of the money that
                  we make in our business goes towards funding the many and
                  varied community education events, workshops and engagements
                  that we offer.
                </p>
              </blockquote>
              ...
              <p>
                ...
                Australian Home Funeral Alliance and the Natural Death Advocacy
                Network.
              </p>

              <p>
                Our work in this space is to help skill our community in the
                area of dying and death care. It is to give you the knowledge to
                know the questions to ask, the discussions to have and who to
            ...
            <div className="bg-emerald-50/60 border border-emerald-100 rounded-2xl p-6 md:p-8 h-fit">
              ...
              <p className="mt-4 text-gray-700 leading-relaxed">
                We find these sessions are an invaluable way for people to talk
                to us and each other. By engaging in meaningful and honest
                conversation in a safe and supported environment we have found
                that people walk away feeling far more at ease with what was an
          ...
          <section className="bg-emerald-700 text-white rounded-2xl p-6 md:p-8 mb-8">
            ...
            <p className="mt-4 text-emerald-50 leading-relaxed max-w-3xl">
              In the unlikely event that we can&apos;t help, we will also inform
              you of other people and services within the community who may be
