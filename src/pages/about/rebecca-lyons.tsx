          ...
          <div className="grid lg:grid-cols-[340px_1fr] gap-10 lg:gap-16 items-start">
            ...
            >
              <p className="text-xl md:text-2xl text-gray-800 leading-relaxed font-light">
                Rebecca Lyons, known to many as Bec, is a funeral director, End
                of Life Doula, educator, author and long-time advocate for more
                personal, family-led approaches to death care.
              </p>

              <div className="mt-8 space-y-5 text-lg text-gray-700 leading-relaxed">
                <p>
                  Bec hails from the Blue Mountains in NSW but made Tasmania her
                  home in 2006. Over her career she has worked in various
                  industries including finance, real estate and the law, but in
                  2011 she found her path into the funeral industry and stayed
                  there until mid-2017.
                </p>
                ...
                <p>
                  ...
                  Retraining as an End of Life Doula and becoming an independent
                  Funeral Director, she has worked in home based death care and
                  family led funerals ever since.
                </p>
                ...
                <p>
                  ...
                  through alternate technologies and approaches’. A link to her
                  Churchill report can be found by{" "}
                  <a
                ...
                <p>
                  ...
                  approach to death care are her passion and she loves being out
                  in the community raising awareness and promoting good honest
                  conversations, she is a dedicated advocate for positive
                  change.
                </p>
              </div>
