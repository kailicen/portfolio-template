          ...
          <div className="py-8 md:py-12">
            ...
            >
              <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 mb-6">
                Making the Conversation about Death and Dying, Just Another Part
                of Life
              </h2>

              <p>
                Edwin and Bec have worked in and around the death care industry
                for many years and have been constantly astonished by the amount
                of people unprepared when confronted by their own inevitable
                death or that of a family member or friend. In 2016, in response
                to this, we put together a group of like-minded family and
                friends to start a community conversation online and in person
                with aims of:
              </p>
              ...
              <p>
                We can have as much or as little a say as we like about things
                such as:
              </p>

              <ul className="list-disc pl-6 space-y-2 my-6">
                <li>
                  The circumstances around us (music, people, light, colours
                  etc)
                </li>
              ...
              <p>
                ...
                important and relevant legal aspects to the planning process,
                but sometimes it&apos;s just about how you want it to be, to
                feel, and what you want to leave behind for people as a legacy.
              </p>
              ...
              <blockquote className="border-l-4 border-emerald-600 pl-6 py-4 my-8 bg-gray-50 rounded-r-lg">
                <p className="text-lg italic text-gray-800">
                  ...
                  being able to talk openly about it. Often the first
              ...
              <p>
                ...
                their friends and communities to have an integral part of the
                death care process. Death was an accepted part of life.
              </p>

              <p>
                Death has always been the last rite of passage for a
                person&apos;s journey on earth. No matter the religion or moral
                conviction of a person, the event of someone dying is the last
                time that person is formally honoured in our society. What we
                have seen more recently is a kind of removal from that, where
                for many years now people have been encouraged to hand over the
                body of a deceased loved one to strangers... Through doing so
                there has been a loss of the knowledge around what that really
                means.
              </p>

              <p>
                There are social, emotional and financial implications
                surrounding the decisions made about death and dying and often
                they are not made as truly informed choices. Increasingly, the
              ...
              <p>
                ...
                difference? We think it would and so that is what we aim to do.
                That is why we want to talk about death and dying. So that
                people can make informed decisions because they know their
                rights and options, know what choices are actually theirs to
                make and can make them based on real and transparent knowledge
              ...
              <p>
                ...
                there who will personally go above and beyond to help a family
                they are looking after - it is a humbling thing to be invited
                into a family at a vulnerable time and many of the good
                directors feel the weight of this space.
              </p>

              <p>
                It is equally true that the funeral industry has perpetuated the
                mystery and taboo around death by orchestrating their services
                in such a way that has resulted in many of the decisions and
                power being taken away from the families; the families are often
                none the wiser, or they are made to feel as though it is easier
                to go the standard route - or their only choice.
              </p>
            </motion.article>
            ...
            <div className="mt-12">
              <div className="rounded-2xl bg-emerald-700 text-white px-6 py-8 md:px-10 md:py-12 shadow-sm">
                ...
                <p className="mt-4 text-base md:text-lg leading-relaxed text-emerald-50 max-w-4xl">
                  What is right for you is always going to be a personal choice,
                  and if it is right for you, it is right. We are working
                  towards building our collective community knowledge base to a
                  point where people will no longer find themselves saying
                  &quot;I wish I&apos;d known that was possible...&quot;
                </p>
