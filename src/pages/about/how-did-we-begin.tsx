    ...
    <div className="bg-white text-black min-h-screen flex flex-col">
      ...
      <div className="max-w-6xl mx-auto w-full 2xl:max-w-7xl 2xl:text-lg md:text-base flex-1">
        ...
        <motion.article
          ...
          className="px-4 md:px-10 py-8 space-y-8 text-gray-700 leading-relaxed"
        >
          <div>
          ...
          <section className="space-y-5">
            <p>
              ...
              it can be dignified and authentic no matter what it is or where it
              is. It is important for people to have the space to gather, to
              mourn together and support each other in grief, but it does not
          ...
          <section className="space-y-5">
            ...
            <p>
              ...
              all these things together and have been offering a family led and
              community based funeral service ever since.
            </p>
            ...
            <blockquote className="border-l-4 border-emerald-600 pl-6 py-4 bg-gray-50 rounded-r-lg">
              <p className="text-lg italic text-gray-800">
                ...
                decisions when it comes to dying and death. We are committed to
                creating a space in the community for conversation and education
                to challenge the taboos and misconceptions around death and
                dying.
              </p>
            </blockquote>
          </section>
          ...
          <section className="space-y-5">
            ...
            <p>
              And so, we started with a desire to encourage people to make good,
              informed choices that are right for them. The honest truth is,
              that for the most part, you don&apos;t actually need a funeral
              director for the ceremony. If you want one, that&apos;s great - we
              want that to be an intentional and informed choice for people, a
          ...
          <section className="space-y-5">
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                The surroundings and atmosphere of the space like music, people,
                light, colours, scents etc.
              </li>
            ...
            <p>
              ...
              want it to be, to feel, and what memories you want to leave behind
              for people as a legacy, memories.
            </p>
            ...
            <blockquote className="border-l-4 border-emerald-600 pl-6 py-4 bg-gray-50 rounded-r-lg">
              <p className="italic text-gray-800">
                ...
                able to talk about it openly. Often the first conversations
                people are having about death is after the event, when they walk
                into a funeral home and say, &quot;I don&apos;t know what to
                do&quot;.
              </p>
            </blockquote>
          </section>
          ...
          <section className="space-y-5">
            ...
            <p>
              ...
              the decisions made about death care and often they are not made as
              truly informed choices. Increasingly, the opportunity to honour
              the dead is put out of reach for people due to the increasing
              costs associated with &apos;traditional&apos; funerals. We are
              keen to shed light on more natural and cost-effective ways of
              making the process of honouring a person&apos;s death more
              accessible and achievable for everyone.
            </p>

            <p>
              People need to reclaim some of the control over our dead that has
              been surrendered in the last 150 years.
            </p>
            ...
            <p>
              ...
              Prior to the turn of the century members of the community held the
              knowledge of death care and families regularly cared for their
              people in the home. Today, this isn’t always possible, or even
              desirable for some, but approaching funerals with a family and
              community focus always is. This means everything will be co
            ...
            <blockquote className="border-l-4 border-emerald-600 pl-6 py-4 bg-gray-50 rounded-r-lg">
              <p className="italic text-gray-800">
                ...
                bereavement will only ever be made gentler by allowing ourselves
                the control and choice over how we deal with and spend time with
                our dead.
              </p>
            </blockquote>
          </section>
          ...
          <section className="space-y-5">
            ...
            <p>
              ...
              their friends and communities to be an integral part of the death
              care process. Death was an accepted part of life.
            </p>

            <p>
              What we have seen for many years now is people being encouraged to
              hand over the body of a deceased loved one to strangers. Through
              doing so, there has been a loss of community knowledge regarding
              the care of our dead.
            </p>
          </section>
          ...
          <section className="space-y-5">
            ...
            <p>
              ...
              someone dying is the last time that person is formally honoured in
              our society.
            </p>

            <p>
              What if people planning a funeral were able to make truly informed
              choices?
            </p>
            ...
            <p>
              ...
              decisions are then based on real and transparent knowledge of the
              death care industry and systems. And that matters.
            </p>
            ...
            <p>
              ...
              at a vulnerable time after all, and many of the good directors
              feel the weight of this space.
            </p>
            ...
            <p>
              ...
              of the power is taken away from families. These families are often
              none the wiser; they are made to feel that it is easier to go the
              standard route or that is their only choice.
            </p>

            <p>
              This is often where the problem lies; with the companies and the
              management and systems they have built around them. That is where
              the feeling of ‘cookie cutter’ approaches come from when expensive
              things are pushed that give very little return or benefit for the
              grief and healing journeys of loved ones.
            </p>
